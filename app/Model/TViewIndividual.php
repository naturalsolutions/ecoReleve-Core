<?php
	...
	class TViewIndividual extends AppModel {	
		public $useTable = 'TViewIndividual';	
		public $primaryKey = 'Individual_Obj_PK';
				
		public $hasMany = array(
			'Status' => array(
				'className' => 'TObjectCaracValue',
				'foreignKey' => 'fk_object',
				'fields' => array('value_precision','begin_date','end_date','creation_date','comments'),
